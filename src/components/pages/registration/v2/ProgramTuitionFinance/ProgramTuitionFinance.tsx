...
const ProgramTuitionFinance = () => {
  ...
  return (
    <div className="pt-[60px] md:pt-[100px] lg:pt-[160px]">
      ...
      <div className="container px-[30px] mt-[30px] md:mt-[48px]">
        ...
        <div className="bg-[#B9E0FE] px-[10px] md:px-[30px] lg:px-[72px] py-[30px] md:py-[55px] md:flex gap-x-[105px]">
          ...
          <div className="w-full">
            <h3 className="text-[20px] font-semibold mb-[20px]">
              {sProgramTuitionFinanceTabs[activeTab]?.title}
            </h3>
            <h4 className="font-medium">
              {sProgramTuitionFinanceTabs[activeTab]?.amount}
            </h4>
            <p className="text-lightdark mt-[10px]">
              {sProgramTuitionFinanceTabs[activeTab]?.body}
            </p>
          </div>
        </div>
      </div>
