          ...
          data.data.videos.map(
            (
              ...
              <div
                ...
                key={_id}
                className="flex items-center py-3 px-1 bg-transparent flex-row md:max-w-xl hover:bg-gray-100 lg:max-w-xl cursor-pointer "
              >
                <div>
                ...
                <div className="w-full">
                  <div
                    className={`w-full flex justify-end items-end p-2  mx-3 h-[120px] rounded-xl ${style.CompletedLesBg}`}
                  >
                  ...
                  <p
                    className={` ${click === _id ? "text-[#3a59e2]" : ""
                      } text-small-text-color text-[16px] capitalize  mt-[10px] ml-[20px]`}
                  >
                    {topicName}
                  </p>
                </div>
