...
import { useGetPartnersAllQuery } from "../../../../../feature/api/fourthit/partners/partnersApi";
import Loading from "../../../../common/Loading";
import ModalDialog from "../../../../layouts/ModalDialog";
import CreateModal from "./Modal/CreateModal";
import ResourceTable from "./PartnersTable";
  ...
  return (
    <>
      ...
      <div className="flex justify-between">
        <h2 className="text-[28px] font-semibold leading-[36px]">Partners</h2>
        <button
