...
import { useGetTypesAllQuery } from "../../../../../feature/api/fourthit/types/typesApi";
import Loading from "../../../../common/Loading";
import ModalDialog from "../../../../layouts/ModalDialog";
import CreateModal from "./Modal/CreateModal";
import ResourceTable from "./TypesTable";
...
const Types = () => {
  ...
  const { data, isLoading, isSuccess, isFetching } = useGetTypesAllQuery<any>({
    limit: limit,
    page: currentPage,
  });
  ...
  return (
    <>
      ...
      <div className="flex justify-between">
        <h2 className="text-[28px] font-semibold leading-[36px]">Types</h2>
        <button
