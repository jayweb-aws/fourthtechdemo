...
} from "../../../../../../feature/api/fourthit/management/managementApi";
...
const UpdateModal = ({ closeModal, id }: { closeModal: any; id: any }) => {
  ...
  useEffect(() => {
    if (singleManagementSuccess) {
      setFieldValue("name", singleManagementData?.data?.management?.name);
      setFieldValue("role", singleManagementData?.data?.management?.role);
      setFieldValue(
        "linkedin",
        singleManagementData?.data?.management?.linkedin
      );
      setFieldValue("twitter", singleManagementData?.data?.management?.twitter);
      setFieldValue("photo", singleManagementData?.data?.management?.photo);
      setFieldValue("key", singleManagementData?.data?.management?.key);
    }
