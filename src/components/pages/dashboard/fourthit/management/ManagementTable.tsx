...
import { useDeleteManagementMutation } from "../../../../../feature/api/fourthit/management/managementApi";
      ...
      {isOpen && modal === "delete" && (
        ...
        >
          <DeleteModal
            variant="Category"
            closeModal={closeModal}
            rtkMutation={useDeleteManagementMutation}
            title={"Do you want delete this management !"}
            id={id}
            successMsg="Management delete success"
          />
        </ModalDialog>
      )}
      {isOpen && modal === "edit" && (
